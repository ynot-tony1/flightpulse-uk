...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-border text-ink-muted transition-colors hover:bg-paper-subtle hover:text-ink"
    >
